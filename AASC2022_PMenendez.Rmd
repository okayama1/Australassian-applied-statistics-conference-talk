...
.content-box-soft[
-  Some projects require a single tool (R, Phython, Matlab or Genstat for example) and involve only one person.
]
...
- Have a look for more GUI clients [here](https://git-scm.com/downloads/guis). 
...
.orange[Think about all this in advance. It is worth!]
