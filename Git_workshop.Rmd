...
* Entitles to think more broadly.
]
]
...
.content-box-soft[
-  Some projects require a single tool (R or Phython for example) and involves only one person.
]
...
<br>  
.content-box-neutral[ 
Having clarity about the project files architecture
gives you total control over its organisation.
]
